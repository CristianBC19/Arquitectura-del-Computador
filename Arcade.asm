...
DATA SEGMENT PARA 'DATA'
    ...
    HIT_FORCE_STRONG DW 0FFEEh  ; Fuerza fuerte -20 
    ...
    SCORE_LEFT DB 00h           
    SCORE_RIGHT DB 00h          
    WINNING_SCORE DB 05h        ; Puntos necesarios para ganar
...
;---------------------------------------------------------
    ...
    ; Salida: Carry Flag = 1 si hay (4+ toques)
    ;------------------------------------------------------------------
    ...
    ; DRAW_BALL_SPRITE_11X11 - Dibuja el sprite del balon 11x11
    ...
    DRAW_SPRITE_COL_11:
        ...
        MOV AL, [SI]                 ; Obtener color del p�xel
    ...
    DRAW_SCORE PROC NEAR
        ...
        ; Convertir y mostrar dos d?gitos
        MOV AL, SCORE_LEFT
    ...
    AI_BALL_ON_RIGHT_SIDE:
        ; Verificar si la pelota est� inactiva (modo saque)
        CMP BALL_ACTIVE, 00h
        JE AI_SERVE_MODE
        JMP AI_NORMAL_MODE
    ...
    AI_SERVE_CHECK_Y:
        ...
        ; Verificar si el paddle est� cerca 
    ...
    AI_SERVE_READY_TO_JUMP:
        ; Verificar si el paddle est� en el suelo
        CMP PADDLE_RIGHT_ON_GROUND, 01h
        JNE AI_SERVE_DONE       ; Ya est� saltando, esperar
    ...
    AI_SERVE_OVERLAP:
        ; Hay solapamiento horizontal - saltar si esta en el suelo
        CMP PADDLE_RIGHT_ON_GROUND, 01h
        JNE AI_SERVE_DONE
        JMP AI_SERVE_JUMP
    ...
    AI_NORMAL_MODE:
        ...
        ; Si la diferencia es peque�a (5 pixels), considerar alineado
        CMP BX, 03h
        JLE AI_CHECK_JUMP
    ...
    AI_MOVE_LEFT:
        ...
        JLE AI_CHECK_JUMP       ; Ya est� en el limite
    ...
    AI_DIST_DONE:
        ...
        ; Verificar si la pelota est� cayendo (velocidad Y positiva)
        MOV AX, BALL_VELOCITY_Y
        CMP AX, 0
...
RIGHT_RIGHT_CLAMP_END:
    ...
    PLAY_SCORE_SOUND PROC NEAR
        ...
        OR AL, 03h               ; Activar bits 0 y 1 (altavoz y gate)
        ...
        OUT 42h, AL              ; Enviar byte alto despu�s
